...
expName = 'lossaver_test_imm'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'F:\\Lossaver_Information\\lossaver\\lossaver_test_imm.psyexp',
...
for thisRun in runs:
    ...
    trials = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('test_trials_imm.xlsx'),
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        followup_onset = trial_clock.getTime()
